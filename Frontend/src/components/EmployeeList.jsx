  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header Section */}
        <div className="bg-white/10 backdrop-blur-2xl border border-white/20 shadow-2xl rounded-3xl overflow-hidden mb-8 transition-all duration-500 hover:bg-white/20 hover:backdrop-blur-3xl hover:scale-105 hover:shadow-cyan-400/40">
          ...
          <div className="px-6 py-4 border-b border-gray-200">
            <div className="relative max-w-md">
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-white/20 bg-white/20 text-white rounded-lg focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 shadow-sm transition-all duration-300 hover:bg-cyan-400/10 hover:scale-105 placeholder-white/60"
              />
              <svg
        ...
        {/* Employee Table */}
        <div className="bg-white/10 backdrop-blur-2xl border border-white/20 shadow-2xl rounded-3xl overflow-hidden transition-all duration-500 hover:bg-white/20 hover:backdrop-blur-3xl hover:scale-105 hover:shadow-cyan-400/40">
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {employees.map(employee => (
                  <tr key={employee._id} className="hover:bg-cyan-400/10 hover:scale-[1.01] transition-all duration-300 cursor-pointer">
