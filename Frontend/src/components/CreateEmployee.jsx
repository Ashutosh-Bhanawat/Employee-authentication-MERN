...
const CreateEmployee = ({ editMode }) => {
  ...
  const fetchRoles = async () => {
    try {
      const response = await fetch('https://employee-authentication-mern.onrender.com/api/roles');
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-white/20 bg-white/20 text-white rounded-lg focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 shadow-sm transition-all duration-300 hover:bg-cyan-400/10 hover:scale-105 placeholder-white/60"
                    required
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={3}
                    className="w-full px-4 py-2 border border-white/20 bg-white/20 text-white rounded-lg focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 shadow-sm transition-all duration-300 hover:bg-cyan-400/10 hover:scale-105 placeholder-white/60 resize-none"
                  />
                </div>
              </div>
            </div>
